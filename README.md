...
Welcome to the UXIBOOST project! This web application showcases stunning animated gradients that enhance user interface designs. Built with HTML and CSS, UXIBOOST aims to provide designers and developers with inspiration and tools to elevate their UI projects.

[Video.webm](https://github.com/user-attachments/assets/a1273606-f416-41ea-a8fb-e4c59c2e692d)

## Features
- Animated Gradients: Eye-catching gradients that animate beautifully, adding a dynamic feel to your web pages.
- Responsive Design: Optimized for various devices, ensuring a seamless experience across desktops and mobile devices.
- Easy Integration: Simple HTML and CSS structure that makes it easy to incorporate into your own projects.
- Modern Aesthetic: A clean and visually appealing layout inspired by contemporary design trends.

![Full-Screen-Capture](https://github.com/user-attachments/assets/fcc95c47-151d-4280-9564-5d55becee955)

## Technology Stack
- HTML: For structuring the content of the website.
- CSS: For styling and implementing the animated gradients.
...
- git clone https://github.com/your-username/uxiboost.git
- cd uxiboost
- Open index.html in your web browser.

## Figma Design Link
https://www.figma.com/design/zN0VivjcDFBiajbvkv5bAx/Master-Mesh-Animated-Gradient-in-Figma!-%F0%9F%8C%88-%7C-Amazing-Background-for-Website-UI-%5BDay-82%2F100-Challenge-(Community)?node-id=5-50&t=g14pBK2E6j0z6C8B-0
